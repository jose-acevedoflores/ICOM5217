...
main:   NOP                             ; main program
        ...
        bis.w   #SELA_2+SELS_2,&UCSCTL4       ; Set SMCLK source to REFOCLOCK
        ...
        bis.w   #0001h, &TA0CCR0                ; Count up to FFFF
        bis.w   #TAIDEX_2, &TA0EX0              ; Divide input signal by 4
        eint
...
timer:  xor.b   #BIT5,P8OUT             ; Toggle status of buzzer signal
