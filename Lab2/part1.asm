...
GOBACK  mov.w   #WriteLCD, 2(SP) ; Modified return address to write on the LCD display
        bic.b   #GIE,0(SP)       ; Disable interrupts 
	    reti
...
Shift      rla.b UNITS			; capture msb by rotating
   ...
   ; Prep UNITS and TENS to be readable by the LCD
	   ...
	   bis.b #01100000b, UNITS	; Add upper part that enables the numbers to be displayed in the LCD
	   
	   bis.b #01100000b, TENS	; Add upper part that enables the numbers to be displayed in the LCD
